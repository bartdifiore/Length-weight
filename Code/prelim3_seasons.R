# -----------------------------------------------------------------------------
# Preliminary Code 3: this code tests for differences in season as well as 
# decade. Still a WIP - needs to be fixed, and the coeffs.R file will be fixed
# and added at the end here.
# -----------------------------------------------------------------------------
library(tidyverse)
